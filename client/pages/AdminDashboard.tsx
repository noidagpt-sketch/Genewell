...
type TabType = 'overview' | 'users' | 'quiz' | 'purchases' | 'downloads' | 'traffic' | 'products' | 'settings';
...
export default function AdminDashboard() {
  ...
  const loadProducts = async () => {
    setIsLoading(true);
    try {
      const response = await fetch('/api/admin/products', { headers: { 'X-Admin-Token': adminToken } });
